...
<template>
    ...
    <el-input
            ...
            placeholder="借阅者"
    />
  <el-button @click="postBorrowingBook" type="primary">借阅</el-button>
</template>
...
const borrowingBookUrl=ref('http://localhost:8080/borrowing');
const book=ref('')
const user=ref('')
...
const clear=():void=>{
    borrowingBookUrl.value='http://localhost:8080/borrowing';
    book.value='';
    user.value='';
}
</script>
